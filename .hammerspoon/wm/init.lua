...
module.start = function()
	...
	local filters = {
		...
		{ app = "iTerm", title="Hotkey Window", tile= false}
	}

	hhtwm.margin = 12
	hhtwm.screenMargin = { top = 36, bottom = 12, left = 12, right = 12 }
	hhtwm.filters = filters
	hhtwm.calcResizeStep = calcResizeStep
	hhtwm.defaultLayout = "main-center"
	hhtwm.enabledLayouts = { "main-center", "main-left", "monocle", "equal-left", "equal-right", "main-right" }
	hhtwm.start()
end
